...
class GameFragment : Fragment() {
    ...
    private val questions: MutableList<Question> = mutableListOf(
            ...
            Question(text = "Where is the manifest file located?",
                    answers = listOf("Root", "Drawable file", "Layout file", "Gradle file")),
            Question(text = "Which is a type of app component?",
                    answers = listOf("Activites", "Services", "Gradle file", "App manifest"))

...
class GameWonFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.nextMatchButton.setOnClickListener {
            it.findNavController().navigate(GameWonFragmentDirections.actionGameWonFragment2ToGameFragment2())
        }
//        Toast.makeText(context, "Number Correct: ${args.numCorrect}, Number Answered: ${args.numQuestions}",
